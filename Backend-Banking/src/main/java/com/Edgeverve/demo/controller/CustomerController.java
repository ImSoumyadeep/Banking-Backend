...
public class CustomerController {
	...
	@CrossOrigin
	@PostMapping("/transfer/{acid}/{amount}")      //Fund Transfer
	@ResponseBody
	public boolean transferMoney(@PathVariable String acid, @PathVariable double amount)
	{
		if(checkRecevierAndBalance(acid,amount))
		{
			...
			return true;  // Transaction is success
	...
	*/
	...
	@CrossOrigin
	@GetMapping("/ministatement/{acid}")   // getting MiniStatements from the database.
	@ResponseBody
	...
	/* Surya's code I commented
	  
	@CrossOrigin
	@GetMapping("/transactions/{acid}")   // getting transactions from the database => MiniStatement
	@ResponseBody
